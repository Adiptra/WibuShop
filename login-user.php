    ...
    <div class="container">
        ...
        font-family: 'Fredoka', sans-serif;">
            <div class="row contentForm" style="margin: 8%" >
                ...
                <h2 class="text-center">Login User</h2>
                    <form action="login/cek_login.php" method="post">
                        <div class="mb-3">
                            ...
                            <input placeholder="Masukkan Username Anda" type="text" class="form-control" id="username" name="nm_pelanggan" value="<?php echo $username?>" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                ...
                <p>Belum Punya Akun? <a href="login/signup.php" style="text-decoration: none;">Sign Up</a></p>
                </div>
            </div>
        </div>
    </div>
